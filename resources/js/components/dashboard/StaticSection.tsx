...
const StaticSection = () => {
    ...
    const LossIcon = `${import.meta.env.VITE_APP_URL_ICONS}/icon-loss.png`;
    ...
    const { pengeluaranModal, pengeluaranUntung } = userPengeluaran();
    ...
    return (
        <div className="grid grid-cols-2 gap-2 px-2 md:grid-cols-6 md:gap-4 md:px-5">
            ...
            <StaticCard ImgUrl={LossIcon} title="Pengeluaran Modal" price={pengeluaranModal} />
            <StaticCard ImgUrl={LossIcon} title="Pengeluaran Keuntungan" price={pengeluaranUntung} />
        </div>
    );
};
